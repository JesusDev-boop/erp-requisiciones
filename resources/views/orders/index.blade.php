    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h2 class="text-3xl font-black text-white tracking-tight">
                Asignación de Números de Órdenes de Compra
            </h2>
...
<div class="bg-white/5 backdrop-blur-xl border border-white/10 shadow-2xl rounded-[2.5rem] overflow-hidden">
...
<select name="estatus"
class="w-full px-4 py-2 rounded-xl bg-slate-800 text-white border border-slate-600">

<option value="">Todos</option>
<option value="borrador" {{ request('estatus')=='borrador'?'selected':'' }}>Borrador</option>
<option value="emitida" {{ request('estatus')=='emitida'?'selected':'' }}>Emitida</option>
...
<div>
<button type="submit"
class="w-full px-4 py-2 bg-indigo-600 hover:bg-indigo-700 text-white rounded-xl text-xs font-bold shadow">
Filtrar
</button>
</div>
...
class="px-3 py-2 bg-purple-600 hover:bg-purple-700 text-white rounded-xl text-xs font-bold">
Editar
</a>
